...
import { selectedItems, ctrlPressed, setSelectedItems, automat, mapItems, setSelectedImgItem, setSelectionStart, setSelectionEnd, updateSelection, setPreviousMapItems } from "./global"
...
export class MapItem implements SquareMap {
  ...
  constructor(x: number, y: number) {
    ...
    this.canvas.addEventListener("mouseup", () => this.unClick());
  }
  ...
  */
  ...
  /**
 * @param img - ImageData for the background of the MapItem
 */
...
export class ImgItem implements Square {
  ...
  /**
 * @param i - coordinate x in the map
 * @param j - coordinate y in the map
 */
